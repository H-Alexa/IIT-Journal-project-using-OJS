<?php return array (
  ...
  'manager.setup.emailSignature.description' => 'The prepared emails that are sent by the system on behalf of the journal will have the following signature added to the end.',
  ...
  'manager.setup.reviewOptions.reviewerAccessKeysEnabled.description' => 'Reviewers can be sent a secure link in the email invitation, which will allow them to access the review without logging in. Access to other pages requires them to log in.',
