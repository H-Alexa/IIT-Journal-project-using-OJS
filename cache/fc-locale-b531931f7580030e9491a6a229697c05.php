<?php return array (
  ...
  'manager.emails.resetAll.complete' => 'The default email templates have been restored.',
  'manager.emails.reset' => 'Reset',
  'manager.emails.resetComplete' => 'Email template was successfully reset.',
  ...
  'manager.statistics.reports.customReportGenerator' => 'Custom Report Generator',
  ...
  'manager.setup.notifyUsers.sending' => 'Sending the email. Please do not browse away until sending is complete.',
  'manager.setup.notifyUsers.sent' => 'Email was successfully sent to all recipients.',
  ...
  'manager.setup.dateTime.description' => 'Choose the preferred format for dates and times. A custom format can be entered using the special <a href=\'http://php.net/manual/en/function.strftime.php#refsect1-function.strftime-parameters\'>format characters</a>.',
